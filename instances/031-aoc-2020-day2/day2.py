...
print('day 2.0 problem returns a total number of valid passwords of:',number_of_good_passwords)
...
for item in input:
    ...
    if((all_chars[A-1]==char and all_chars[B-1]!=char) or (all_chars[A-1] != char and all_chars[B-1] == char)):
        number_of_good_passwords +=1

print('day 2.1 problem returns a total number of valid passwords of:',number_of_good_passwords)
